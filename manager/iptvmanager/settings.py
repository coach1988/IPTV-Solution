...
__DEFAULT_MANAGEMENT_URL = 'http://localhost'
...
CSRF_TRUSTED_ORIGINS = [os.environ['MANAGEMENT_URL']] if 'MANAGEMENT_URL' in os.environ else [__DEFAULT_MANAGEMENT_URL]
...
MANAGEMENT_URL = os.environ['MANAGEMENT_URL'] if 'MANAGEMENT_URL' in os.environ else __DEFAULT_MANAGEMENT_URL
